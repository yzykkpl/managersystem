...
var DD_belatedPNG = {
	...
	**/
	...
	attachHandlers: function(el) {
		...
		el.attachEvent('onpropertychang e', this.readPropertyChange);
	},
...
try {
	document.execCommand("BackgroundImag   eCache", false, true); /* TredoSoft Multiple IE doesn't like this, so try{} it */
} catch(r) {}
